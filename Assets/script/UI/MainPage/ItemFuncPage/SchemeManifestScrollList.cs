...
public class SchemeManifestScrollList : MonoBehaviour {
    /// <summary>
    /// 所有不使用的皮肤的存放处
    /// </summary>
    ...
    private SchemeManifestContent content;
    ...
    public SchemeManifestScrollList()
    {
        ////
    }
    ...
    public void Awake()
    {
        ...
        content = contenttrans.gameObject.AddComponent<SchemeManifestContent>();
