...
/// 户型设计状态开启 设置初始点
/// </summary>
public class SetFirstPointState : InputState2D{

    public const string NAME = "SetFirstPointState";
    private bool moved;

    public SetFirstPointState():base(NAME)
    {
    ...
    public override void mUpdate()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            setState(SetOtherPointState.NAME);
        }
    }
