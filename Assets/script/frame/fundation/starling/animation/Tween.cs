...
namespace starling
{
    ...
    public class Tween : EventDispatcher, ITickable
    {
	
		public delegate void CallbackDelegate();
		public delegate void CallbackDelegateWithArgs(object[] args);
		
		new private object mTarget;
		...
		public Tween reset(object target, float time, object transition=null)
		{
		    ...
		    {
		        throw new ArgumentException("Transition must be either a string or a function");
		    }
		...
		public void tick()
		{
		    ...
		    if (previousTime < mTotalTime && mCurrentTime >= mTotalTime)
		    {
		        ...
		        else
		        {
		            ...
		            dispatchEvent( new EventX(EventX.REMOVED));
		...
		public float getEndValue(string property)
		{
		    ...
		    if (index == -1) throw new ArgumentException("The property '" + property + "' is not animated");
		...
		{ 
			...
			set { 
				...
				if (mTransitionFunc == null)
					throw new ArgumentException("Invalid transiton: " + value);
			}
		}
		...
		public static void toPool(Tween tween)
		{
		    ...
		    tween.removeEventListeners(EventX.REMOVE_FROM_JUGGLER);
